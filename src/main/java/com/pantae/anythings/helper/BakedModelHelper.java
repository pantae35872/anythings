...
public class BakedModelHelper {
    ...
    public static BakedQuad quad(Vec3 v1, Vec3 v2, Vec3 v3, Vec3 v4, TextureAtlasSprite sprite, float u1, float u2, float vv1, float vv2) {
        Vec3 normal = v3.subtract(v2).cross(v1.subtract(v2)).normalize();
        ...
        builder.setSprite(sprite);
        builder.setDirection(Direction.getNearest(normal.x, normal.y, normal.z));
        putVertex(builder, normal, v1.x, v1.y, v1.z, vv1 / 16, vv2 / 16, sprite);
        putVertex(builder, normal, v2.x, v2.y, v2.z, vv1 / 16, u2 / 16, sprite);
        putVertex(builder, normal, v3.x, v3.y, v3.z, u1 / 16, u2 / 16, sprite);
        putVertex(builder, normal, v4.x, v4.y, v4.z, u1 / 16, vv2 / 16, sprite);
        return quad[0];
    }
